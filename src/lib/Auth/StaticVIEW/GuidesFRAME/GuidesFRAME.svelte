...
<main in:scale>
        <p class="px2 py-1 bg-gradient-to-l from-yellow-500 to-blue-400 text-center font-semibold">ICCT SCHOLARSHIP PROGRAM</p>
        <section class="flex flex-col gap-1 mt-5 ">
                <p class="font-semibold">What standards apply to scholarships?</p>
                <p class="italic text-rose-500 font-bold">At ICCT Colleges, financial aid is offered in the form of scholarships, student employment, and tuition discounts.</p>
        ...
        <p class="mt-2 italic text-rose-500 font-bold">
            A Scholarship committee shall screen student applicants and will determine the qualified students. Two scholarship slots shall be allotted for the following programs; BSN, BSC, BSECE, BSA, BSEd, BEEd, BSMedTEch, BSHRM.
        </p>
</main>