...
<footer class="bg-gradient-to-b  sm:bg-gradient-to-r from-[#22180d] to-yellow-900 text-white p-2 mt-10 text-xs sm:text-base ">
    <div class="flex flex-col sm:flex-row gap-2">
        <div class="flex flex-col gap-2  p-5 w-full">
            ...
            <p class="leading-7">
                Our system is designed to be secure and reliable, with advanced encryption and security features to protect your personal information. We understand that privacy and security are paramount when it comes to enrollment, which is why we have taken every precaution to ensure that your information is safe and protected.
            </p>
        </div>
        ...
        <div class="flex flex-col justify-center items-center p-5 gap-2 w-full">
            <img src={ICCTicon} alt="loading" class="w-[150px]" />
            <p class="text-center font-bold">ICCT Colleges Enrollment System Design and Implementation for Incoming Students for the Year 2023</p>
        </div>
